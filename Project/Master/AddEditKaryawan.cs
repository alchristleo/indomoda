...
namespace Project
{
    public partial class AddEditKaryawan : MetroFramework.Forms.MetroForm
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                MetroFramework.MetroMessageBox.Show(this, "Please enter employee name!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                lblEmployeeName.Focus();
                return;
            }
            else if (String.IsNullOrEmpty(lblEmployeeCode.Text))
            {
                MetroFramework.MetroMessageBox.Show(this, "Please enter employee code!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                lblEmployeeCode.Focus();
                return;
            }
            else if (String.IsNullOrEmpty(lblEmployeeEmail.Text))
            {
                MetroFramework.MetroMessageBox.Show(this, "Please enter employee email!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                lblEmployeeEmail.Focus();
                return;
            }
            else if (!isEmail)
            {
                MetroFramework.MetroMessageBox.Show(this, "Wrong email format! Ex: budi@gmail.com", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                lblEmployeeEmail.Focus();
                return;
            }
            else if (String.IsNullOrEmpty(lblEmployeePhone.Text))
            {
                MetroFramework.MetroMessageBox.Show(this, "Please enter employee phone!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                lblEmployeePhone.Focus();
                return;
            }
            else if (String.IsNullOrEmpty(lblEmployeePosition.Text))
            {
                MetroFramework.MetroMessageBox.Show(this, "Please enter employee position!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Warning);
