...
namespace Project
{
    public partial class DetailPC : MetroFramework.Forms.MetroForm
    {
        public DetailPC()
        {
            InitializeComponent();
        ...
        private void DetailPC_Load(object sender, EventArgs e)
        {
            ...
            {
                string query = LaporanPenerimaanCMT.npc;
                colorBindingSource.DataSource = db.Colors.ToList();
                List<LaporanPCModel> all = GenericQuery.SqlQuery<LaporanPCModel>("SELECT a.idDetail, a.noPenerimaan, a.noSPK, a.noSeri, a.type, a.tempSablon, a.tempBordir, a.tempCMT, b.model, b.ColorID, b.merk, b.ukuran, c.qtyAwalCMT, c.qtyCMTBS, c.qtyCMTHilang FROM DetailPenerimaanSBC a JOIN ListPenerimaanTukangPotong b ON a.noSeri = b.noSeri JOIN QuantityRecord c ON a.noSeri = c.noSeri WHERE a.type = 'cmt' AND a.noPenerimaan = '" + query + "'");
