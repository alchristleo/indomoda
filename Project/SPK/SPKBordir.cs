...
namespace Project
{
    public partial class SPKBordir : MetroFramework.Forms.MetroForm
    {
        ...
        private void btnAddSPKBordir_Click(object sender, EventArgs e)
        {
            ...
            AddSpkBordir addspk = new AddSpkBordir();
        ...
        private void SPKBordir_Load(object sender, EventArgs e)
        {
        ...
        private void afterSave()
        {
            ...
            btnExitSPKBordir.Location = new Point(500, 591);
        }

        private void btnSaveSPKBordir_Click(object sender, EventArgs e)
        {
            if (txtNoSpkBordir.Text == "")
            {
                MetroFramework.MetroMessageBox.Show(this, "No SPK Bordir must be filled!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
                txtNoSpkBordir.Focus();
            }
            else if (cboPICBordir.Items.Count > 0 && txtPicCodeBordir.Text == "")
            {
            ...
            else
            {
                try
                {
                    using (indomodaEntities db = new indomodaEntities())
                    {
                        ...
                        int setEID = Convert.ToInt32(cboPICBordir.SelectedValue.ToString());
        ...
        private void btnDeleteSPKBordir_Click(object sender, EventArgs e)
        {
        ...
        private void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            {
                MetroFramework.MetroMessageBox.Show(this, "You must save this No. SPK Bordir to database first!", "Message", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
            else
            {
                try
